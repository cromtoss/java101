...
/**
 * Decorates ElderOne objects, allowing them to gibber.
 */
public class GibberingDecorator implements ElderOne {

    private ElderOne elderOne;


    public GibberingDecorator(ElderOne elderOne) {
    ...
    public void speakFromBeyond() {
        ...
        System.out.println("From fear, I gibber");
    }
