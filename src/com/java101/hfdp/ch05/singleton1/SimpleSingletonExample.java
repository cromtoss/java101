/*	$Header: //software/misc/user/crosta/java101/src/com/devket/hfdp/ch05/singleton1/SimpleSingletonExample.java#1 $
 *
...
public final class SimpleSingletonExample {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		// Serialize/deserialize the singleton for fun.
		...
		final SimpleSingleton deserializedRef = (SimpleSingleton) inputStream.readObject();
